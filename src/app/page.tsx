...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#FFF8E7] text-[#2D1B0F]">
      {/* ── Nav ─────────────────────────────────────────────── */}
      <nav className="sticky top-0 z-50 backdrop-blur-md bg-[#FFF8E7]/80 border-b border-[#2D1B0F]/10">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link href="/" className="text-2xl font-black tracking-tight">
            🧀 Tu Queso
          </Link>
          <Link
            href="https://wa.me/56956273260?text=Hola%20quiero%20pedir%20queso%20%F0%9F%A7%80"
      ...
      <section className="bg-[#2D1B0F] text-[#FFF8E7] py-24">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-4xl md:text-5xl font-black text-center mb-16">
            ¿Por qué <span className="text-[#FFC93C]">Tu Queso</span>?
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              >
                ...
                <Link
                  href={`https://wa.me/56956273260?text=Hola%20quiero%20un%20queso%20${p.name.toLowerCase()}%20%F0%9F%A7%80`}
      ...
      <section id="suscripcion" className="py-24 px-6 bg-[#2D1B0F] text-[#FFF8E7]">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl text-[#FFF8E7]/70 mb-16">
            Hasta 7,5% off + queso gratis cada 8 entregas 🎁
          </p>
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              >
                ...
                <Link
                  href="https://wa.me/56956273260?text=Hola%20me%20interesa%20una%20suscripci%C3%B3n"
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              ...
              { q: "¿Puedo cancelar mi suscripción?", a: "Cuando quieras, sin compromiso. Tienes un portal personal para pausar, cambiar fecha o cancelar." },
      ...
      <footer className="bg-[#2D1B0F] text-[#FFF8E7] py-12 px-6">
        ...
        <p className="text-center text-[#FFF8E7]/40 text-sm mt-8">
          © 2026 Tu Queso · Todos los derechos reservados
        </p>
      </footer>
    </div>
  );
